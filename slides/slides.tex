...
\begin{frame}
  ...
  \begin{itemize}
    \item Hongwei Xi and Frank Pfenning. Eliminating array bound checking
      through dependent types
    \item Patrick M. Rondon, Ming Kawaguci, and Ranjit Jhala. Liquid types
    \item Niki Vazou, Eric L. Seidel, Ranjit Jhala, Dimitros Vytionitis, and
      Simon Peyton-Jones. Refinement Types For Haskell
  \end{itemize}
\end{frame}
